...
const Main = () => {
  return (
    <div className=" relative ">
      ...
      <div className="absolute left-[52%] top-[-8%] -translate-x-1/2 bgs-amber-800 w-full group ">
        <Image
          src="/hunter.png"
          height={400}
          width={400}
        ...
        />
         <div className="absolute  bottom-14 h-1/2 z-50 w-full bg-gradient-to-t from-[#0A0A0A] via-[#0A0A0A]/80 to-transparent "></div>
